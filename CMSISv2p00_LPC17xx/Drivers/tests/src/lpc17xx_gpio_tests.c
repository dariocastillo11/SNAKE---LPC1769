...
uint8_t GPIO_SetDirTest(void) {
    ...
    GPIO_SetDir(GPIO_PORT_0, 0xFF, GPIO_INPUT);
    EXPECT_EQUAL((LPC_GPIO0->FIODIR & PORT_0_MASK), (0xFFFFFF00 & PORT_0_MASK));

    GPIO_SetDir(GPIO_PORT_0, 0xCF, GPIO_OUTPUT);
...
uint8_t GPIO_ClearValueTest(void) {
    ...
    GPIO_ClearPins(GPIO_PORT_0, 0x0F0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0xFFFFF0F0 & PORT_0_MASK));

    GPIO_ClearPins(GPIO_PORT_0, 0x0FF0);
    PROPAGATION_DELAY();
...
uint8_t FIO_HalfWordSetDirTest(void) {
    ...
    FIO_HalfWordSetDir(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0xFF, GPIO_INPUT);
    EXPECT_EQUAL((LPC_GPIO0->FIODIR & PORT_0_MASK), (0xFFFFFF00 & PORT_0_MASK));

    FIO_HalfWordSetDir(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0xFF, GPIO_INPUT);
    EXPECT_EQUAL((LPC_GPIO0->FIODIR & PORT_0_MASK), (0xFF00FF00 & PORT_0_MASK));

    FIO_HalfWordSetDir(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0xFF, GPIO_OUTPUT);
    EXPECT_EQUAL((LPC_GPIO0->FIODIR & PORT_0_MASK), (0xFF00FFFF & PORT_0_MASK));

    FIO_HalfWordSetDir(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0xF0, GPIO_OUTPUT);
...
uint8_t FIO_HalfWordSetValueTest(void) {
    ...
    FIO_HalfWordSetPins(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0x0F0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x00000F0F & PORT_0_MASK));

    FIO_HalfWordSetPins(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0x0FF0);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0FF00F0F & PORT_0_MASK));

    FIO_HalfWordSetPins(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0xF0F0);
    PROPAGATION_DELAY();
...
uint8_t FIO_HalfWordClearValueTest(void) {
    ...
    FIO_HalfWordClearPins(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0x0F0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0xFFFFF0F0 & PORT_0_MASK));

    FIO_HalfWordClearPins(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0x0FF0);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0xFFFFF000 & PORT_0_MASK));

    FIO_HalfWordClearPins(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0x0FF0);
    PROPAGATION_DELAY();
...
uint8_t FIO_HalfWordWriteValueTest(void) {
    ...
    FIO_HalfWordWriteValue(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0x0F0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x00000F0F & PORT_0_MASK));

    FIO_HalfWordWriteValue(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0xFF00);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0000FF00 & PORT_0_MASK));

    FIO_HalfWordWriteValue(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0x000F);
    PROPAGATION_DELAY();
...
uint8_t FIO_HalfWordReadValueTest(void) {
    ...
    EXPECT_EQUAL((FIO_HalfWordReadValue(GPIO_PORT_0, GPIO_HALFWORD_LOW) & PORT_0_HW_MASK_LOW), (0x55 & PORT_0_HW_MASK_LOW));
    EXPECT_EQUAL((FIO_HalfWordReadValue(GPIO_PORT_0, GPIO_HALFWORD_HIGH) & PORT_0_HW_MASK_HIGH), (0x66 & PORT_0_HW_MASK_HIGH));
...
uint8_t FIO_HalfWordTogglePinsTest(void) {
    ...
    FIO_HalfWordTogglePins(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0xF00F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0000F00F & PORT_0_MASK));

    FIO_HalfWordTogglePins(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0xFFFF);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x00000FF0 & PORT_0_MASK));

    FIO_HalfWordTogglePins(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0xF0F0);
    PROPAGATION_DELAY();
...
uint8_t FIO_HalfWordSetMaskTest(void) {
    ...
    FIO_HalfWordSetMask(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0xF00F, ENABLE);
    EXPECT_EQUAL((LPC_GPIO0->FIOMASK & PORT_0_MASK), (0x0000F00F & PORT_0_MASK));

    FIO_HalfWordSetMask(GPIO_PORT_0, GPIO_HALFWORD_LOW, 0x00FF, DISABLE);
    EXPECT_EQUAL((LPC_GPIO0->FIOMASK & PORT_0_MASK), (0x0000F000 & PORT_0_MASK));

    FIO_HalfWordSetMask(GPIO_PORT_0, GPIO_HALFWORD_HIGH, 0x0FF0, ENABLE);
...
uint8_t FIO_ByteSetDirTest(void) {
    ...
    FIO_ByteSetDir(GPIO_PORT_0, GPIO_BYTE_0, 0xFF, GPIO_INPUT);
    EXPECT_EQUAL((LPC_GPIO0->FIODIR & PORT_0_MASK), (0xFFFFFF00 & PORT_0_MASK));

    FIO_ByteSetDir(GPIO_PORT_0, GPIO_BYTE_0, 0xFF, GPIO_OUTPUT);
    EXPECT_EQUAL((LPC_GPIO0->FIODIR & PORT_0_MASK), (0xFFFFFFFF & PORT_0_MASK));

    FIO_ByteSetDir(GPIO_PORT_0, GPIO_BYTE_3, 0xFF, GPIO_INPUT);
    EXPECT_EQUAL((LPC_GPIO0->FIODIR & PORT_0_MASK), (0x00FFFFFF & PORT_0_MASK));

    FIO_ByteSetDir(GPIO_PORT_0, GPIO_BYTE_3, 0xF0, GPIO_OUTPUT);
...
uint8_t FIO_ByteSetValueTest(void) {
    ...
    FIO_ByteSetPins(GPIO_PORT_0, GPIO_BYTE_0, 0x0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0000000F & PORT_0_MASK));

    FIO_ByteSetPins(GPIO_PORT_0, GPIO_BYTE_0, 0x00);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0000000F & PORT_0_MASK));

    FIO_ByteSetPins(GPIO_PORT_0, GPIO_BYTE_3, 0xF0);
    PROPAGATION_DELAY();
...
uint8_t FIO_ByteClearValueTest(void) {
    ...
    FIO_ByteClearPins(GPIO_PORT_0, GPIO_BYTE_0, 0x0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0xFFFFFFF0 & PORT_0_MASK));

    FIO_ByteClearPins(GPIO_PORT_0, GPIO_BYTE_0, 0x00);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0xFFFFFFF0 & PORT_0_MASK));

    FIO_ByteClearPins(GPIO_PORT_0, GPIO_BYTE_3, 0xF0);
    PROPAGATION_DELAY();
...
uint8_t FIO_ByteWriteValueTest(void) {
    ...
    FIO_ByteWriteValue(GPIO_PORT_0, GPIO_BYTE_0, 0x0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0000000F & PORT_0_MASK));

    FIO_ByteWriteValue(GPIO_PORT_0, GPIO_BYTE_0, 0x00);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x00000000 & PORT_0_MASK));

    FIO_ByteWriteValue(GPIO_PORT_0, GPIO_BYTE_3, 0x0F);
    PROPAGATION_DELAY();
...
uint8_t FIO_ByteReadValueTest(void) {
    ...
    EXPECT_EQUAL((FIO_ByteReadValue(GPIO_PORT_0, GPIO_BYTE_0) & PORT_0_B0_MASK), (0x55 & PORT_0_B0_MASK));
    EXPECT_EQUAL((FIO_ByteReadValue(GPIO_PORT_0, GPIO_BYTE_1) & PORT_0_B1_MASK), (0x43 & PORT_0_B1_MASK));
    EXPECT_EQUAL((FIO_ByteReadValue(GPIO_PORT_0, GPIO_BYTE_2) & PORT_0_B2_MASK), (0x66 & PORT_0_B2_MASK));
    EXPECT_EQUAL((FIO_ByteReadValue(GPIO_PORT_0, GPIO_BYTE_3) & PORT_0_B3_MASK), (0x12 & PORT_0_B3_MASK));
...
uint8_t FIO_ByteTogglePinsTest(void) {
    ...
    FIO_ByteTogglePins(GPIO_PORT_0, GPIO_BYTE_0, 0x0F);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0000000F & PORT_0_MASK));

    FIO_ByteTogglePins(GPIO_PORT_0, GPIO_BYTE_0, 0x00);
    PROPAGATION_DELAY();
    EXPECT_EQUAL((LPC_GPIO0->FIOPIN & PORT_0_MASK), (0x0000000F & PORT_0_MASK));

    FIO_ByteTogglePins(GPIO_PORT_0, GPIO_BYTE_3, 0xFF);
    PROPAGATION_DELAY();
...
uint8_t FIO_ByteSetMaskTest(void) {
    ...
    FIO_ByteSetMask(GPIO_PORT_0, GPIO_BYTE_0, 0xF0, ENABLE);
    EXPECT_EQUAL((LPC_GPIO0->FIOMASK & PORT_0_MASK), (0x000000F0 & PORT_0_MASK));

    FIO_ByteSetMask(GPIO_PORT_0, GPIO_BYTE_0, 0x0F, DISABLE);
    EXPECT_EQUAL((LPC_GPIO0->FIOMASK & PORT_0_MASK), (0x000000F0 & PORT_0_MASK));

    FIO_ByteSetMask(GPIO_PORT_0, GPIO_BYTE_3, 0xFF, ENABLE);
